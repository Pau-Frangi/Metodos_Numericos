...
\begin{itemize}
    ...
    \]
    Y también se puede calcular como la raíz cuadrada del máximo autovalor de $ A^* A $, es decir:
    \[
...
\begin{teorema}
    Sea $A \in \mathbb{K}^{m \times n}$ una matriz, entonces su norma 1 es:
    \[
        \|A\|_1 = \max_{1 \leq j \leq n} \| a_j \|_1
    \]
    Siendo $ a_j $ la $ j $-ésima columna de $ A $.
\end{teorema}