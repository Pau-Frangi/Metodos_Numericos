...
Estos apuntes han sido elaborados por Pau Frangi Mahiques, Diego Rodríguez Cubero y Jaime Nieto Petinal, estudiantes de 3.º del Doble Grado en Matemáticas e Ingeniería Informática, con el objetivo de ofrecer un material claro, cohesionado y útil para el estudio de la asignatura de Métodos Numéricos.

El contenido está basado en las clases del profesor Valeri Makarov, a quien agradecemos su dedicación y claridad expositiva.

El documento está organizado para acompañar el progreso del curso. En la parte teórica se estudian las matrices y sus propiedades, la resolución de sistemas lineales, los métodos iterativos, la interpolación polinómica, la diferenciación numérica, la integración numérica y la resolución de ecuaciones no lineales. Se incluyen asimismo ejercicios seleccionados y exámenes resueltos, junto con material gráfico y esquemas realizados con TikZ para apoyar la intuición geométrica y numérica.
...
\begin{itemize}
    ...
    \item Mandarnos un correo electrónico a:
	\begin{itemize}
