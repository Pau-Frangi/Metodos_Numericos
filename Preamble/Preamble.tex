...
% Comando para ejercicios con estado, autoria, enunciado y desarrollo.
% Estados: enunciado (rojo), medio (naranja), resuelto (verde).
% Autoria del resuelto: profesor (marca), no (sin marca).
\newcommand{\ejercicioestado}[1]{%
  \def\ejerciciocolor{red!75!black}%
  \IfStrEq{#1}{enunciado}{\def\ejerciciocolor{red!75!black}}{}%
  \IfStrEq{#1}{medio}{\def\ejerciciocolor{orange!85!black}}{}%
  \IfStrEq{#1}{resuelto}{\def\ejerciciocolor{green!55!black}}{}%
}

\newcommand{\ejerciciomarca}[1]{%
  \def\ejerciciooverlay{}%
  \IfStrEq{#1}{profesor}{%
    \def\ejerciciooverlay{%
      \node[
        anchor=north east,
      ...
      ] at ([xshift=-2mm,yshift=-2mm]frame.north east) {Prof};%
    }%
  }{}%
}

\newcommand{\ejercicio}[4]{%
  ...
  \begin{tcolorbox}[
    ...
    left=10pt, right=10pt, top=10pt, bottom=10pt,
    breakable,
    overlay unbroken={\ejerciciooverlay},
    overlay first={\ejerciciooverlay},
